...
#define LV_MEM_CUSTOM 0
    ...
    #define LV_MEM_ADR  0xD0177000UL    //0x30000000     /* 直接放到两块 framebuffer 之后的 SDRAM 区域 */
...
#define LV_USE_GPU_STM32_DMA2D 1
    ...
    #define LV_GPU_DMA2D_CMSIS_INCLUDE "stm32h743xx.h"
		/* 这份 LVGL DMA2D 后端用 STM32H7 宏选择 RCC_AHB3ENR_DMA2DEN 分支，
       而 ST 的设备头通常只给 STM32H743xx 这类具体型号宏，因此这里补一个兼容映射。 */
    #ifndef STM32H7
        #define STM32H7 1
    #endif
#endif
